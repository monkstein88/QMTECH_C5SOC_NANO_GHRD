	component soc_system is
		port (
			button_pio_ext_export              : in    std_logic_vector(1 downto 0)  := (others => 'X'); -- export
			dipsw_pio_ext_export               : in    std_logic_vector(3 downto 0)  := (others => 'X'); -- export
			led_pio_ext_export                 : out   std_logic;                                        -- export
	...
	u0 : component soc_system
		port map (
			button_pio_ext_export              => CONNECTED_TO_button_pio_ext_export,              --          button_pio_ext.export
			dipsw_pio_ext_export               => CONNECTED_TO_dipsw_pio_ext_export,               --           dipsw_pio_ext.export
			...
			hps_memory_mem_a                   => CONNECTED_TO_hps_memory_mem_a,                   --              hps_memory.mem_a
			hps_memory_mem_ba                  => CONNECTED_TO_hps_memory_mem_ba,                  --                        .mem_ba
			hps_memory_mem_ck                  => CONNECTED_TO_hps_memory_mem_ck,                  --                        .mem_ck
			hps_memory_mem_ck_n                => CONNECTED_TO_hps_memory_mem_ck_n,                --                        .mem_ck_n
			hps_memory_mem_cke                 => CONNECTED_TO_hps_memory_mem_cke,                 --                        .mem_cke
			hps_memory_mem_cs_n                => CONNECTED_TO_hps_memory_mem_cs_n,                --                        .mem_cs_n
			hps_memory_mem_ras_n               => CONNECTED_TO_hps_memory_mem_ras_n,               --                        .mem_ras_n
			hps_memory_mem_cas_n               => CONNECTED_TO_hps_memory_mem_cas_n,               --                        .mem_cas_n
			hps_memory_mem_we_n                => CONNECTED_TO_hps_memory_mem_we_n,                --                        .mem_we_n
			hps_memory_mem_reset_n             => CONNECTED_TO_hps_memory_mem_reset_n,             --                        .mem_reset_n
			hps_memory_mem_dq                  => CONNECTED_TO_hps_memory_mem_dq,                  --                        .mem_dq
			hps_memory_mem_dqs                 => CONNECTED_TO_hps_memory_mem_dqs,                 --                        .mem_dqs
			hps_memory_mem_dqs_n               => CONNECTED_TO_hps_memory_mem_dqs_n,               --                        .mem_dqs_n
			hps_memory_mem_odt                 => CONNECTED_TO_hps_memory_mem_odt,                 --                        .mem_odt
			hps_memory_mem_dm                  => CONNECTED_TO_hps_memory_mem_dm,                  --                        .mem_dm
			hps_memory_oct_rzqin               => CONNECTED_TO_hps_memory_oct_rzqin,               --                        .oct_rzqin
