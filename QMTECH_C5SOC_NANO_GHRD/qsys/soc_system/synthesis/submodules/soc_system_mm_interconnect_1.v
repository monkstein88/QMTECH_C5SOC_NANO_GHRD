...
module soc_system_mm_interconnect_1 (
		input  wire        in_clk_50m_clk_clk,                                     //                                   in_clk_50m_clk.clk
		input  wire        avl_mm_bridge_reset_reset_bridge_in_reset_reset,        //        avl_mm_bridge_reset_reset_bridge_in_reset.reset
		input  wire        jtag_master_fpga_clk_reset_reset_bridge_in_reset_reset, // jtag_master_fpga_clk_reset_reset_bridge_in_reset.reset
		input  wire [17:0] avl_mm_bridge_m0_address,                               //                                 avl_mm_bridge_m0.address
		output wire        avl_mm_bridge_m0_waitrequest,                           //                                                 .waitrequest
		input  wire [0:0]  avl_mm_bridge_m0_burstcount,                            //                                                 .burstcount
		input  wire [3:0]  avl_mm_bridge_m0_byteenable,                            //                                                 .byteenable
		input  wire        avl_mm_bridge_m0_read,                                  //                                                 .read
		output wire [31:0] avl_mm_bridge_m0_readdata,                              //                                                 .readdata
		output wire        avl_mm_bridge_m0_readdatavalid,                         //                                                 .readdatavalid
		input  wire        avl_mm_bridge_m0_write,                                 //                                                 .write
		input  wire [31:0] avl_mm_bridge_m0_writedata,                             //                                                 .writedata
		input  wire        avl_mm_bridge_m0_debugaccess,                           //                                                 .debugaccess
		input  wire [31:0] jtag_master_fpga_master_address,                        //                          jtag_master_fpga_master.address
		output wire        jtag_master_fpga_master_waitrequest,                    //                                                 .waitrequest
		input  wire [3:0]  jtag_master_fpga_master_byteenable,                     //                                                 .byteenable
		input  wire        jtag_master_fpga_master_read,                           //                                                 .read
		output wire [31:0] jtag_master_fpga_master_readdata,                       //                                                 .readdata
		output wire        jtag_master_fpga_master_readdatavalid,                  //                                                 .readdatavalid
		input  wire        jtag_master_fpga_master_write,                          //                                                 .write
		input  wire [31:0] jtag_master_fpga_master_writedata,                      //                                                 .writedata
		...
		output wire [5:0]  ilc_component_avalon_slave_address,                     //                       ilc_component_avalon_slave.address
		output wire        ilc_component_avalon_slave_write,                       //                                                 .write
		output wire        ilc_component_avalon_slave_read,                        //                                                 .read
		input  wire [31:0] ilc_component_avalon_slave_readdata,                    //                                                 .readdata
		output wire [31:0] ilc_component_avalon_slave_writedata,                   //                                                 .writedata
	...
	wire          avl_mm_bridge_m0_translator_avalon_universal_master_0_waitrequest;          // avl_mm_bridge_m0_agent:av_waitrequest -> avl_mm_bridge_m0_translator:uav_waitrequest
	wire   [31:0] avl_mm_bridge_m0_translator_avalon_universal_master_0_readdata;             // avl_mm_bridge_m0_agent:av_readdata -> avl_mm_bridge_m0_translator:uav_readdata
	wire          avl_mm_bridge_m0_translator_avalon_universal_master_0_debugaccess;          // avl_mm_bridge_m0_translator:uav_debugaccess -> avl_mm_bridge_m0_agent:av_debugaccess
	wire   [31:0] avl_mm_bridge_m0_translator_avalon_universal_master_0_address;              // avl_mm_bridge_m0_translator:uav_address -> avl_mm_bridge_m0_agent:av_address
	wire          avl_mm_bridge_m0_translator_avalon_universal_master_0_read;                 // avl_mm_bridge_m0_translator:uav_read -> avl_mm_bridge_m0_agent:av_read
	wire    [3:0] avl_mm_bridge_m0_translator_avalon_universal_master_0_byteenable;           // avl_mm_bridge_m0_translator:uav_byteenable -> avl_mm_bridge_m0_agent:av_byteenable
	wire          avl_mm_bridge_m0_translator_avalon_universal_master_0_readdatavalid;        // avl_mm_bridge_m0_agent:av_readdatavalid -> avl_mm_bridge_m0_translator:uav_readdatavalid
	wire          avl_mm_bridge_m0_translator_avalon_universal_master_0_lock;                 // avl_mm_bridge_m0_translator:uav_lock -> avl_mm_bridge_m0_agent:av_lock
	wire          avl_mm_bridge_m0_translator_avalon_universal_master_0_write;                // avl_mm_bridge_m0_translator:uav_write -> avl_mm_bridge_m0_agent:av_write
	wire   [31:0] avl_mm_bridge_m0_translator_avalon_universal_master_0_writedata;            // avl_mm_bridge_m0_translator:uav_writedata -> avl_mm_bridge_m0_agent:av_writedata
	wire    [2:0] avl_mm_bridge_m0_translator_avalon_universal_master_0_burstcount;           // avl_mm_bridge_m0_translator:uav_burstcount -> avl_mm_bridge_m0_agent:av_burstcount
	wire          jtag_master_fpga_master_translator_avalon_universal_master_0_waitrequest;   // jtag_master_fpga_master_agent:av_waitrequest -> jtag_master_fpga_master_translator:uav_waitrequest
	wire   [31:0] jtag_master_fpga_master_translator_avalon_universal_master_0_readdata;      // jtag_master_fpga_master_agent:av_readdata -> jtag_master_fpga_master_translator:uav_readdata
	wire          jtag_master_fpga_master_translator_avalon_universal_master_0_debugaccess;   // jtag_master_fpga_master_translator:uav_debugaccess -> jtag_master_fpga_master_agent:av_debugaccess
	wire   [31:0] jtag_master_fpga_master_translator_avalon_universal_master_0_address;       // jtag_master_fpga_master_translator:uav_address -> jtag_master_fpga_master_agent:av_address
	wire          jtag_master_fpga_master_translator_avalon_universal_master_0_read;          // jtag_master_fpga_master_translator:uav_read -> jtag_master_fpga_master_agent:av_read
	wire    [3:0] jtag_master_fpga_master_translator_avalon_universal_master_0_byteenable;    // jtag_master_fpga_master_translator:uav_byteenable -> jtag_master_fpga_master_agent:av_byteenable
	wire          jtag_master_fpga_master_translator_avalon_universal_master_0_readdatavalid; // jtag_master_fpga_master_agent:av_readdatavalid -> jtag_master_fpga_master_translator:uav_readdatavalid
	wire          jtag_master_fpga_master_translator_avalon_universal_master_0_lock;          // jtag_master_fpga_master_translator:uav_lock -> jtag_master_fpga_master_agent:av_lock
	wire          jtag_master_fpga_master_translator_avalon_universal_master_0_write;         // jtag_master_fpga_master_translator:uav_write -> jtag_master_fpga_master_agent:av_write
	wire   [31:0] jtag_master_fpga_master_translator_avalon_universal_master_0_writedata;     // jtag_master_fpga_master_translator:uav_writedata -> jtag_master_fpga_master_agent:av_writedata
	wire    [2:0] jtag_master_fpga_master_translator_avalon_universal_master_0_burstcount;    // jtag_master_fpga_master_translator:uav_burstcount -> jtag_master_fpga_master_agent:av_burstcount
	...
	wire   [31:0] ilc_component_avalon_slave_agent_m0_readdata;                               // ilc_component_avalon_slave_translator:uav_readdata -> ilc_component_avalon_slave_agent:m0_readdata
	wire          ilc_component_avalon_slave_agent_m0_waitrequest;                            // ilc_component_avalon_slave_translator:uav_waitrequest -> ilc_component_avalon_slave_agent:m0_waitrequest
	wire          ilc_component_avalon_slave_agent_m0_debugaccess;                            // ilc_component_avalon_slave_agent:m0_debugaccess -> ilc_component_avalon_slave_translator:uav_debugaccess
	wire   [31:0] ilc_component_avalon_slave_agent_m0_address;                                // ilc_component_avalon_slave_agent:m0_address -> ilc_component_avalon_slave_translator:uav_address
	wire    [3:0] ilc_component_avalon_slave_agent_m0_byteenable;                             // ilc_component_avalon_slave_agent:m0_byteenable -> ilc_component_avalon_slave_translator:uav_byteenable
	wire          ilc_component_avalon_slave_agent_m0_read;                                   // ilc_component_avalon_slave_agent:m0_read -> ilc_component_avalon_slave_translator:uav_read
	wire          ilc_component_avalon_slave_agent_m0_readdatavalid;                          // ilc_component_avalon_slave_translator:uav_readdatavalid -> ilc_component_avalon_slave_agent:m0_readdatavalid
	wire          ilc_component_avalon_slave_agent_m0_lock;                                   // ilc_component_avalon_slave_agent:m0_lock -> ilc_component_avalon_slave_translator:uav_lock
	wire   [31:0] ilc_component_avalon_slave_agent_m0_writedata;                              // ilc_component_avalon_slave_agent:m0_writedata -> ilc_component_avalon_slave_translator:uav_writedata
	wire          ilc_component_avalon_slave_agent_m0_write;                                  // ilc_component_avalon_slave_agent:m0_write -> ilc_component_avalon_slave_translator:uav_write
	wire    [2:0] ilc_component_avalon_slave_agent_m0_burstcount;                             // ilc_component_avalon_slave_agent:m0_burstcount -> ilc_component_avalon_slave_translator:uav_burstcount
	wire          ilc_component_avalon_slave_agent_rf_source_valid;                           // ilc_component_avalon_slave_agent:rf_source_valid -> ilc_component_avalon_slave_agent_rsp_fifo:in_valid
	wire  [106:0] ilc_component_avalon_slave_agent_rf_source_data;                            // ilc_component_avalon_slave_agent:rf_source_data -> ilc_component_avalon_slave_agent_rsp_fifo:in_data
	wire          ilc_component_avalon_slave_agent_rf_source_ready;                           // ilc_component_avalon_slave_agent_rsp_fifo:in_ready -> ilc_component_avalon_slave_agent:rf_source_ready
	wire          ilc_component_avalon_slave_agent_rf_source_startofpacket;                   // ilc_component_avalon_slave_agent:rf_source_startofpacket -> ilc_component_avalon_slave_agent_rsp_fifo:in_startofpacket
	wire          ilc_component_avalon_slave_agent_rf_source_endofpacket;                     // ilc_component_avalon_slave_agent:rf_source_endofpacket -> ilc_component_avalon_slave_agent_rsp_fifo:in_endofpacket
	wire          ilc_component_avalon_slave_agent_rsp_fifo_out_valid;                        // ilc_component_avalon_slave_agent_rsp_fifo:out_valid -> ilc_component_avalon_slave_agent:rf_sink_valid
	wire  [106:0] ilc_component_avalon_slave_agent_rsp_fifo_out_data;                         // ilc_component_avalon_slave_agent_rsp_fifo:out_data -> ilc_component_avalon_slave_agent:rf_sink_data
	wire          ilc_component_avalon_slave_agent_rsp_fifo_out_ready;                        // ilc_component_avalon_slave_agent:rf_sink_ready -> ilc_component_avalon_slave_agent_rsp_fifo:out_ready
	wire          ilc_component_avalon_slave_agent_rsp_fifo_out_startofpacket;                // ilc_component_avalon_slave_agent_rsp_fifo:out_startofpacket -> ilc_component_avalon_slave_agent:rf_sink_startofpacket
	wire          ilc_component_avalon_slave_agent_rsp_fifo_out_endofpacket;                  // ilc_component_avalon_slave_agent_rsp_fifo:out_endofpacket -> ilc_component_avalon_slave_agent:rf_sink_endofpacket
	wire          cmd_mux_001_src_valid;                                                      // cmd_mux_001:src_valid -> ilc_component_avalon_slave_agent:cp_valid
	wire  [105:0] cmd_mux_001_src_data;                                                       // cmd_mux_001:src_data -> ilc_component_avalon_slave_agent:cp_data
	wire          cmd_mux_001_src_ready;                                                      // ilc_component_avalon_slave_agent:cp_ready -> cmd_mux_001:src_ready
	wire    [5:0] cmd_mux_001_src_channel;                                                    // cmd_mux_001:src_channel -> ilc_component_avalon_slave_agent:cp_channel
	wire          cmd_mux_001_src_startofpacket;                                              // cmd_mux_001:src_startofpacket -> ilc_component_avalon_slave_agent:cp_startofpacket
	wire          cmd_mux_001_src_endofpacket;                                                // cmd_mux_001:src_endofpacket -> ilc_component_avalon_slave_agent:cp_endofpacket
	...
	wire  [105:0] cmd_mux_003_src_data;                                                       // cmd_mux_003:src_data -> button_pio_s1_agent:cp_data
	...
	wire    [5:0] cmd_mux_005_src_channel;                                                    // cmd_mux_005:src_channel -> dipsw_pio_s1_agent:cp_channel
	...
	wire          avl_mm_bridge_m0_agent_cp_valid;                                            // avl_mm_bridge_m0_agent:cp_valid -> router:sink_valid
	wire  [105:0] avl_mm_bridge_m0_agent_cp_data;                                             // avl_mm_bridge_m0_agent:cp_data -> router:sink_data
	wire          avl_mm_bridge_m0_agent_cp_ready;                                            // router:sink_ready -> avl_mm_bridge_m0_agent:cp_ready
	wire          avl_mm_bridge_m0_agent_cp_startofpacket;                                    // avl_mm_bridge_m0_agent:cp_startofpacket -> router:sink_startofpacket
	wire          avl_mm_bridge_m0_agent_cp_endofpacket;                                      // avl_mm_bridge_m0_agent:cp_endofpacket -> router:sink_endofpacket
	wire          jtag_master_fpga_master_agent_cp_valid;                                     // jtag_master_fpga_master_agent:cp_valid -> router_001:sink_valid
	wire  [105:0] jtag_master_fpga_master_agent_cp_data;                                      // jtag_master_fpga_master_agent:cp_data -> router_001:sink_data
	wire          jtag_master_fpga_master_agent_cp_ready;                                     // router_001:sink_ready -> jtag_master_fpga_master_agent:cp_ready
	wire          jtag_master_fpga_master_agent_cp_startofpacket;                             // jtag_master_fpga_master_agent:cp_startofpacket -> router_001:sink_startofpacket
	wire          jtag_master_fpga_master_agent_cp_endofpacket;                               // jtag_master_fpga_master_agent:cp_endofpacket -> router_001:sink_endofpacket
	...
	wire          ilc_component_avalon_slave_agent_rp_valid;                                  // ilc_component_avalon_slave_agent:rp_valid -> router_003:sink_valid
	wire  [105:0] ilc_component_avalon_slave_agent_rp_data;                                   // ilc_component_avalon_slave_agent:rp_data -> router_003:sink_data
	wire          ilc_component_avalon_slave_agent_rp_ready;                                  // router_003:sink_ready -> ilc_component_avalon_slave_agent:rp_ready
	wire          ilc_component_avalon_slave_agent_rp_startofpacket;                          // ilc_component_avalon_slave_agent:rp_startofpacket -> router_003:sink_startofpacket
	wire          ilc_component_avalon_slave_agent_rp_endofpacket;                            // ilc_component_avalon_slave_agent:rp_endofpacket -> router_003:sink_endofpacket
	...
	wire  [105:0] button_pio_s1_agent_rp_data;                                                // button_pio_s1_agent:rp_data -> router_005:sink_data
	...
	wire          router_src_valid;                                                           // router:src_valid -> avl_mm_bridge_m0_limiter:cmd_sink_valid
	wire  [105:0] router_src_data;                                                            // router:src_data -> avl_mm_bridge_m0_limiter:cmd_sink_data
	wire          router_src_ready;                                                           // avl_mm_bridge_m0_limiter:cmd_sink_ready -> router:src_ready
	wire    [5:0] router_src_channel;                                                         // router:src_channel -> avl_mm_bridge_m0_limiter:cmd_sink_channel
	wire          router_src_startofpacket;                                                   // router:src_startofpacket -> avl_mm_bridge_m0_limiter:cmd_sink_startofpacket
	wire          router_src_endofpacket;                                                     // router:src_endofpacket -> avl_mm_bridge_m0_limiter:cmd_sink_endofpacket
	wire  [105:0] avl_mm_bridge_m0_limiter_cmd_src_data;                                      // avl_mm_bridge_m0_limiter:cmd_src_data -> cmd_demux:sink_data
	wire          avl_mm_bridge_m0_limiter_cmd_src_ready;                                     // cmd_demux:sink_ready -> avl_mm_bridge_m0_limiter:cmd_src_ready
	wire    [5:0] avl_mm_bridge_m0_limiter_cmd_src_channel;                                   // avl_mm_bridge_m0_limiter:cmd_src_channel -> cmd_demux:sink_channel
	wire          avl_mm_bridge_m0_limiter_cmd_src_startofpacket;                             // avl_mm_bridge_m0_limiter:cmd_src_startofpacket -> cmd_demux:sink_startofpacket
	wire          avl_mm_bridge_m0_limiter_cmd_src_endofpacket;                               // avl_mm_bridge_m0_limiter:cmd_src_endofpacket -> cmd_demux:sink_endofpacket
	wire          rsp_mux_src_valid;                                                          // rsp_mux:src_valid -> avl_mm_bridge_m0_limiter:rsp_sink_valid
	wire  [105:0] rsp_mux_src_data;                                                           // rsp_mux:src_data -> avl_mm_bridge_m0_limiter:rsp_sink_data
	wire          rsp_mux_src_ready;                                                          // avl_mm_bridge_m0_limiter:rsp_sink_ready -> rsp_mux:src_ready
	wire    [5:0] rsp_mux_src_channel;                                                        // rsp_mux:src_channel -> avl_mm_bridge_m0_limiter:rsp_sink_channel
	wire          rsp_mux_src_startofpacket;                                                  // rsp_mux:src_startofpacket -> avl_mm_bridge_m0_limiter:rsp_sink_startofpacket
	wire          rsp_mux_src_endofpacket;                                                    // rsp_mux:src_endofpacket -> avl_mm_bridge_m0_limiter:rsp_sink_endofpacket
	wire          avl_mm_bridge_m0_limiter_rsp_src_valid;                                     // avl_mm_bridge_m0_limiter:rsp_src_valid -> avl_mm_bridge_m0_agent:rp_valid
	wire  [105:0] avl_mm_bridge_m0_limiter_rsp_src_data;                                      // avl_mm_bridge_m0_limiter:rsp_src_data -> avl_mm_bridge_m0_agent:rp_data
	wire          avl_mm_bridge_m0_limiter_rsp_src_ready;                                     // avl_mm_bridge_m0_agent:rp_ready -> avl_mm_bridge_m0_limiter:rsp_src_ready
	wire    [5:0] avl_mm_bridge_m0_limiter_rsp_src_channel;                                   // avl_mm_bridge_m0_limiter:rsp_src_channel -> avl_mm_bridge_m0_agent:rp_channel
	wire          avl_mm_bridge_m0_limiter_rsp_src_startofpacket;                             // avl_mm_bridge_m0_limiter:rsp_src_startofpacket -> avl_mm_bridge_m0_agent:rp_startofpacket
	wire          avl_mm_bridge_m0_limiter_rsp_src_endofpacket;                               // avl_mm_bridge_m0_limiter:rsp_src_endofpacket -> avl_mm_bridge_m0_agent:rp_endofpacket
	wire          router_001_src_valid;                                                       // router_001:src_valid -> jtag_master_fpga_master_limiter:cmd_sink_valid
	wire  [105:0] router_001_src_data;                                                        // router_001:src_data -> jtag_master_fpga_master_limiter:cmd_sink_data
	wire          router_001_src_ready;                                                       // jtag_master_fpga_master_limiter:cmd_sink_ready -> router_001:src_ready
	wire    [5:0] router_001_src_channel;                                                     // router_001:src_channel -> jtag_master_fpga_master_limiter:cmd_sink_channel
	wire          router_001_src_startofpacket;                                               // router_001:src_startofpacket -> jtag_master_fpga_master_limiter:cmd_sink_startofpacket
	wire          router_001_src_endofpacket;                                                 // router_001:src_endofpacket -> jtag_master_fpga_master_limiter:cmd_sink_endofpacket
	wire  [105:0] jtag_master_fpga_master_limiter_cmd_src_data;                               // jtag_master_fpga_master_limiter:cmd_src_data -> cmd_demux_001:sink_data
	wire          jtag_master_fpga_master_limiter_cmd_src_ready;                              // cmd_demux_001:sink_ready -> jtag_master_fpga_master_limiter:cmd_src_ready
	wire    [5:0] jtag_master_fpga_master_limiter_cmd_src_channel;                            // jtag_master_fpga_master_limiter:cmd_src_channel -> cmd_demux_001:sink_channel
	wire          jtag_master_fpga_master_limiter_cmd_src_startofpacket;                      // jtag_master_fpga_master_limiter:cmd_src_startofpacket -> cmd_demux_001:sink_startofpacket
	wire          jtag_master_fpga_master_limiter_cmd_src_endofpacket;                        // jtag_master_fpga_master_limiter:cmd_src_endofpacket -> cmd_demux_001:sink_endofpacket
	wire          rsp_mux_001_src_valid;                                                      // rsp_mux_001:src_valid -> jtag_master_fpga_master_limiter:rsp_sink_valid
	wire  [105:0] rsp_mux_001_src_data;                                                       // rsp_mux_001:src_data -> jtag_master_fpga_master_limiter:rsp_sink_data
	wire          rsp_mux_001_src_ready;                                                      // jtag_master_fpga_master_limiter:rsp_sink_ready -> rsp_mux_001:src_ready
	wire    [5:0] rsp_mux_001_src_channel;                                                    // rsp_mux_001:src_channel -> jtag_master_fpga_master_limiter:rsp_sink_channel
	wire          rsp_mux_001_src_startofpacket;                                              // rsp_mux_001:src_startofpacket -> jtag_master_fpga_master_limiter:rsp_sink_startofpacket
	wire          rsp_mux_001_src_endofpacket;                                                // rsp_mux_001:src_endofpacket -> jtag_master_fpga_master_limiter:rsp_sink_endofpacket
	wire          jtag_master_fpga_master_limiter_rsp_src_valid;                              // jtag_master_fpga_master_limiter:rsp_src_valid -> jtag_master_fpga_master_agent:rp_valid
	wire  [105:0] jtag_master_fpga_master_limiter_rsp_src_data;                               // jtag_master_fpga_master_limiter:rsp_src_data -> jtag_master_fpga_master_agent:rp_data
	wire          jtag_master_fpga_master_limiter_rsp_src_ready;                              // jtag_master_fpga_master_agent:rp_ready -> jtag_master_fpga_master_limiter:rsp_src_ready
	wire    [5:0] jtag_master_fpga_master_limiter_rsp_src_channel;                            // jtag_master_fpga_master_limiter:rsp_src_channel -> jtag_master_fpga_master_agent:rp_channel
	wire          jtag_master_fpga_master_limiter_rsp_src_startofpacket;                      // jtag_master_fpga_master_limiter:rsp_src_startofpacket -> jtag_master_fpga_master_agent:rp_startofpacket
	wire          jtag_master_fpga_master_limiter_rsp_src_endofpacket;                        // jtag_master_fpga_master_limiter:rsp_src_endofpacket -> jtag_master_fpga_master_agent:rp_endofpacket
	...
	wire    [5:0] avl_mm_bridge_m0_limiter_cmd_valid_data;                                    // avl_mm_bridge_m0_limiter:cmd_src_valid -> cmd_demux:sink_valid
	wire    [5:0] jtag_master_fpga_master_limiter_cmd_valid_data;                             // jtag_master_fpga_master_limiter:cmd_src_valid -> cmd_demux_001:sink_valid
	...
	wire          ilc_component_avalon_slave_agent_rdata_fifo_src_valid;                      // ilc_component_avalon_slave_agent:rdata_fifo_src_valid -> avalon_st_adapter_001:in_0_valid
	wire   [33:0] ilc_component_avalon_slave_agent_rdata_fifo_src_data;                       // ilc_component_avalon_slave_agent:rdata_fifo_src_data -> avalon_st_adapter_001:in_0_data
	wire          ilc_component_avalon_slave_agent_rdata_fifo_src_ready;                      // avalon_st_adapter_001:in_0_ready -> ilc_component_avalon_slave_agent:rdata_fifo_src_ready
	wire          avalon_st_adapter_001_out_0_valid;                                          // avalon_st_adapter_001:out_0_valid -> ilc_component_avalon_slave_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_001_out_0_data;                                           // avalon_st_adapter_001:out_0_data -> ilc_component_avalon_slave_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_001_out_0_ready;                                          // ilc_component_avalon_slave_agent:rdata_fifo_sink_ready -> avalon_st_adapter_001:out_0_ready
	wire    [0:0] avalon_st_adapter_001_out_0_error;                                          // avalon_st_adapter_001:out_0_error -> ilc_component_avalon_slave_agent:rdata_fifo_sink_error
	...
	) avl_mm_bridge_m0_translator (
		.clk                    (in_clk_50m_clk_clk),                                                  //                       clk.clk
		.reset                  (avl_mm_bridge_reset_reset_bridge_in_reset_reset),                     //                     reset.reset
		.uav_address            (avl_mm_bridge_m0_translator_avalon_universal_master_0_address),       // avalon_universal_master_0.address
		.uav_burstcount         (avl_mm_bridge_m0_translator_avalon_universal_master_0_burstcount),    //                          .burstcount
		.uav_read               (avl_mm_bridge_m0_translator_avalon_universal_master_0_read),          //                          .read
		.uav_write              (avl_mm_bridge_m0_translator_avalon_universal_master_0_write),         //                          .write
		.uav_waitrequest        (avl_mm_bridge_m0_translator_avalon_universal_master_0_waitrequest),   //                          .waitrequest
		.uav_readdatavalid      (avl_mm_bridge_m0_translator_avalon_universal_master_0_readdatavalid), //                          .readdatavalid
		.uav_byteenable         (avl_mm_bridge_m0_translator_avalon_universal_master_0_byteenable),    //                          .byteenable
		.uav_readdata           (avl_mm_bridge_m0_translator_avalon_universal_master_0_readdata),      //                          .readdata
		.uav_writedata          (avl_mm_bridge_m0_translator_avalon_universal_master_0_writedata),     //                          .writedata
		.uav_lock               (avl_mm_bridge_m0_translator_avalon_universal_master_0_lock),          //                          .lock
		.uav_debugaccess        (avl_mm_bridge_m0_translator_avalon_universal_master_0_debugaccess),   //                          .debugaccess
		.av_address             (avl_mm_bridge_m0_address),                                            //      avalon_anti_master_0.address
		.av_waitrequest         (avl_mm_bridge_m0_waitrequest),                                        //                          .waitrequest
		.av_burstcount          (avl_mm_bridge_m0_burstcount),                                         //                          .burstcount
		.av_byteenable          (avl_mm_bridge_m0_byteenable),                                         //                          .byteenable
		.av_read                (avl_mm_bridge_m0_read),                                               //                          .read
		.av_readdata            (avl_mm_bridge_m0_readdata),                                           //                          .readdata
		.av_readdatavalid       (avl_mm_bridge_m0_readdatavalid),                                      //                          .readdatavalid
		.av_write               (avl_mm_bridge_m0_write),                                              //                          .write
		.av_writedata           (avl_mm_bridge_m0_writedata),                                          //                          .writedata
		.av_debugaccess         (avl_mm_bridge_m0_debugaccess),                                        //                          .debugaccess
	...
	altera_merlin_master_translator #(
		...
		.AV_LINEWRAPBURSTS           (0),
		.AV_REGISTERINCOMINGSIGNALS  (0)
	) jtag_master_fpga_master_translator (
		.clk                    (in_clk_50m_clk_clk),                                                         //                       clk.clk
		.reset                  (avl_mm_bridge_reset_reset_bridge_in_reset_reset),                            //                     reset.reset
		.uav_address            (jtag_master_fpga_master_translator_avalon_universal_master_0_address),       // avalon_universal_master_0.address
		.uav_burstcount         (jtag_master_fpga_master_translator_avalon_universal_master_0_burstcount),    //                          .burstcount
		.uav_read               (jtag_master_fpga_master_translator_avalon_universal_master_0_read),          //                          .read
		.uav_write              (jtag_master_fpga_master_translator_avalon_universal_master_0_write),         //                          .write
		.uav_waitrequest        (jtag_master_fpga_master_translator_avalon_universal_master_0_waitrequest),   //                          .waitrequest
		.uav_readdatavalid      (jtag_master_fpga_master_translator_avalon_universal_master_0_readdatavalid), //                          .readdatavalid
		.uav_byteenable         (jtag_master_fpga_master_translator_avalon_universal_master_0_byteenable),    //                          .byteenable
		.uav_readdata           (jtag_master_fpga_master_translator_avalon_universal_master_0_readdata),      //                          .readdata
		.uav_writedata          (jtag_master_fpga_master_translator_avalon_universal_master_0_writedata),     //                          .writedata
		.uav_lock               (jtag_master_fpga_master_translator_avalon_universal_master_0_lock),          //                          .lock
		.uav_debugaccess        (jtag_master_fpga_master_translator_avalon_universal_master_0_debugaccess),   //                          .debugaccess
		.av_address             (jtag_master_fpga_master_address),                                            //      avalon_anti_master_0.address
		.av_waitrequest         (jtag_master_fpga_master_waitrequest),                                        //                          .waitrequest
		.av_byteenable          (jtag_master_fpga_master_byteenable),                                         //                          .byteenable
		.av_read                (jtag_master_fpga_master_read),                                               //                          .read
		.av_readdata            (jtag_master_fpga_master_readdata),                                           //                          .readdata
		.av_readdatavalid       (jtag_master_fpga_master_readdatavalid),                                      //                          .readdatavalid
		.av_write               (jtag_master_fpga_master_write),                                              //                          .write
		.av_writedata           (jtag_master_fpga_master_writedata),                                          //                          .writedata
	...
	altera_merlin_slave_translator #(
		...
		.AV_SETUP_WAIT_CYCLES           (0),
		.AV_DATA_HOLD_CYCLES            (0)
	) ilc_component_avalon_slave_translator (
		.clk                    (in_clk_50m_clk_clk),                                //                      clk.clk
		.reset                  (avl_mm_bridge_reset_reset_bridge_in_reset_reset),   //                    reset.reset
		.uav_address            (ilc_component_avalon_slave_agent_m0_address),       // avalon_universal_slave_0.address
		.uav_burstcount         (ilc_component_avalon_slave_agent_m0_burstcount),    //                         .burstcount
		.uav_read               (ilc_component_avalon_slave_agent_m0_read),          //                         .read
		.uav_write              (ilc_component_avalon_slave_agent_m0_write),         //                         .write
		.uav_waitrequest        (ilc_component_avalon_slave_agent_m0_waitrequest),   //                         .waitrequest
		.uav_readdatavalid      (ilc_component_avalon_slave_agent_m0_readdatavalid), //                         .readdatavalid
		.uav_byteenable         (ilc_component_avalon_slave_agent_m0_byteenable),    //                         .byteenable
		.uav_readdata           (ilc_component_avalon_slave_agent_m0_readdata),      //                         .readdata
		.uav_writedata          (ilc_component_avalon_slave_agent_m0_writedata),     //                         .writedata
		.uav_lock               (ilc_component_avalon_slave_agent_m0_lock),          //                         .lock
		.uav_debugaccess        (ilc_component_avalon_slave_agent_m0_debugaccess),   //                         .debugaccess
		.av_address             (ilc_component_avalon_slave_address),                //      avalon_anti_slave_0.address
		.av_write               (ilc_component_avalon_slave_write),                  //                         .write
		.av_read                (ilc_component_avalon_slave_read),                   //                         .read
		.av_readdata            (ilc_component_avalon_slave_readdata),               //                         .readdata
		.av_writedata           (ilc_component_avalon_slave_writedata),              //                         .writedata
		.av_begintransfer       (),                                                  //              (terminated)
		.av_beginbursttransfer  (),                                                  //              (terminated)
		.av_burstcount          (),                                                  //              (terminated)
		.av_byteenable          (),                                                  //              (terminated)
	...
	altera_merlin_master_agent #(
		...
		.USE_READRESPONSE          (0),
		.USE_WRITERESPONSE         (0)
	) avl_mm_bridge_m0_agent (
		.clk                   (in_clk_50m_clk_clk),                                                  //       clk.clk
		.reset                 (avl_mm_bridge_reset_reset_bridge_in_reset_reset),                     // clk_reset.reset
		.av_address            (avl_mm_bridge_m0_translator_avalon_universal_master_0_address),       //        av.address
		.av_write              (avl_mm_bridge_m0_translator_avalon_universal_master_0_write),         //          .write
		.av_read               (avl_mm_bridge_m0_translator_avalon_universal_master_0_read),          //          .read
		.av_writedata          (avl_mm_bridge_m0_translator_avalon_universal_master_0_writedata),     //          .writedata
		.av_readdata           (avl_mm_bridge_m0_translator_avalon_universal_master_0_readdata),      //          .readdata
		.av_waitrequest        (avl_mm_bridge_m0_translator_avalon_universal_master_0_waitrequest),   //          .waitrequest
		.av_readdatavalid      (avl_mm_bridge_m0_translator_avalon_universal_master_0_readdatavalid), //          .readdatavalid
		.av_byteenable         (avl_mm_bridge_m0_translator_avalon_universal_master_0_byteenable),    //          .byteenable
		.av_burstcount         (avl_mm_bridge_m0_translator_avalon_universal_master_0_burstcount),    //          .burstcount
		.av_debugaccess        (avl_mm_bridge_m0_translator_avalon_universal_master_0_debugaccess),   //          .debugaccess
		.av_lock               (avl_mm_bridge_m0_translator_avalon_universal_master_0_lock),          //          .lock
		.cp_valid              (avl_mm_bridge_m0_agent_cp_valid),                                     //        cp.valid
		.cp_data               (avl_mm_bridge_m0_agent_cp_data),                                      //          .data
		.cp_startofpacket      (avl_mm_bridge_m0_agent_cp_startofpacket),                             //          .startofpacket
		.cp_endofpacket        (avl_mm_bridge_m0_agent_cp_endofpacket),                               //          .endofpacket
		.cp_ready              (avl_mm_bridge_m0_agent_cp_ready),                                     //          .ready
		.rp_valid              (avl_mm_bridge_m0_limiter_rsp_src_valid),                              //        rp.valid
		.rp_data               (avl_mm_bridge_m0_limiter_rsp_src_data),                               //          .data
		.rp_channel            (avl_mm_bridge_m0_limiter_rsp_src_channel),                            //          .channel
		.rp_startofpacket      (avl_mm_bridge_m0_limiter_rsp_src_startofpacket),                      //          .startofpacket
		.rp_endofpacket        (avl_mm_bridge_m0_limiter_rsp_src_endofpacket),                        //          .endofpacket
		.rp_ready              (avl_mm_bridge_m0_limiter_rsp_src_ready),                              //          .ready
		.av_response           (),                                                                    // (terminated)
		.av_writeresponsevalid ()                                                                     // (terminated)
	);
	...
	altera_merlin_master_agent #(
		...
		.USE_READRESPONSE          (0),
		.USE_WRITERESPONSE         (0)
	) jtag_master_fpga_master_agent (
		.clk                   (in_clk_50m_clk_clk),                                                         //       clk.clk
		.reset                 (avl_mm_bridge_reset_reset_bridge_in_reset_reset),                            // clk_reset.reset
		.av_address            (jtag_master_fpga_master_translator_avalon_universal_master_0_address),       //        av.address
		.av_write              (jtag_master_fpga_master_translator_avalon_universal_master_0_write),         //          .write
		.av_read               (jtag_master_fpga_master_translator_avalon_universal_master_0_read),          //          .read
		.av_writedata          (jtag_master_fpga_master_translator_avalon_universal_master_0_writedata),     //          .writedata
		.av_readdata           (jtag_master_fpga_master_translator_avalon_universal_master_0_readdata),      //          .readdata
		.av_waitrequest        (jtag_master_fpga_master_translator_avalon_universal_master_0_waitrequest),   //          .waitrequest
		.av_readdatavalid      (jtag_master_fpga_master_translator_avalon_universal_master_0_readdatavalid), //          .readdatavalid
		.av_byteenable         (jtag_master_fpga_master_translator_avalon_universal_master_0_byteenable),    //          .byteenable
		.av_burstcount         (jtag_master_fpga_master_translator_avalon_universal_master_0_burstcount),    //          .burstcount
		.av_debugaccess        (jtag_master_fpga_master_translator_avalon_universal_master_0_debugaccess),   //          .debugaccess
		.av_lock               (jtag_master_fpga_master_translator_avalon_universal_master_0_lock),          //          .lock
		.cp_valid              (jtag_master_fpga_master_agent_cp_valid),                                     //        cp.valid
		.cp_data               (jtag_master_fpga_master_agent_cp_data),                                      //          .data
		.cp_startofpacket      (jtag_master_fpga_master_agent_cp_startofpacket),                             //          .startofpacket
		.cp_endofpacket        (jtag_master_fpga_master_agent_cp_endofpacket),                               //          .endofpacket
		.cp_ready              (jtag_master_fpga_master_agent_cp_ready),                                     //          .ready
		.rp_valid              (jtag_master_fpga_master_limiter_rsp_src_valid),                              //        rp.valid
		.rp_data               (jtag_master_fpga_master_limiter_rsp_src_data),                               //          .data
		.rp_channel            (jtag_master_fpga_master_limiter_rsp_src_channel),                            //          .channel
		.rp_startofpacket      (jtag_master_fpga_master_limiter_rsp_src_startofpacket),                      //          .startofpacket
		.rp_endofpacket        (jtag_master_fpga_master_limiter_rsp_src_endofpacket),                        //          .endofpacket
		.rp_ready              (jtag_master_fpga_master_limiter_rsp_src_ready),                              //          .ready
		.av_response           (),                                                                           // (terminated)
		.av_writeresponsevalid ()                                                                            // (terminated)
	);
	...
	altera_merlin_slave_agent #(
		...
		.USE_WRITERESPONSE         (0),
		.ECC_ENABLE                (0)
	) ilc_component_avalon_slave_agent (
		.clk                     (in_clk_50m_clk_clk),                                          //             clk.clk
		.reset                   (avl_mm_bridge_reset_reset_bridge_in_reset_reset),             //       clk_reset.reset
		.m0_address              (ilc_component_avalon_slave_agent_m0_address),                 //              m0.address
		.m0_burstcount           (ilc_component_avalon_slave_agent_m0_burstcount),              //                .burstcount
		.m0_byteenable           (ilc_component_avalon_slave_agent_m0_byteenable),              //                .byteenable
		.m0_debugaccess          (ilc_component_avalon_slave_agent_m0_debugaccess),             //                .debugaccess
		.m0_lock                 (ilc_component_avalon_slave_agent_m0_lock),                    //                .lock
		.m0_readdata             (ilc_component_avalon_slave_agent_m0_readdata),                //                .readdata
		.m0_readdatavalid        (ilc_component_avalon_slave_agent_m0_readdatavalid),           //                .readdatavalid
		.m0_read                 (ilc_component_avalon_slave_agent_m0_read),                    //                .read
		.m0_waitrequest          (ilc_component_avalon_slave_agent_m0_waitrequest),             //                .waitrequest
		.m0_writedata            (ilc_component_avalon_slave_agent_m0_writedata),               //                .writedata
		.m0_write                (ilc_component_avalon_slave_agent_m0_write),                   //                .write
		.rp_endofpacket          (ilc_component_avalon_slave_agent_rp_endofpacket),             //              rp.endofpacket
		.rp_ready                (ilc_component_avalon_slave_agent_rp_ready),                   //                .ready
		.rp_valid                (ilc_component_avalon_slave_agent_rp_valid),                   //                .valid
		.rp_data                 (ilc_component_avalon_slave_agent_rp_data),                    //                .data
		.rp_startofpacket        (ilc_component_avalon_slave_agent_rp_startofpacket),           //                .startofpacket
		...
		.rf_sink_ready           (ilc_component_avalon_slave_agent_rsp_fifo_out_ready),         //         rf_sink.ready
		.rf_sink_valid           (ilc_component_avalon_slave_agent_rsp_fifo_out_valid),         //                .valid
		.rf_sink_startofpacket   (ilc_component_avalon_slave_agent_rsp_fifo_out_startofpacket), //                .startofpacket
		.rf_sink_endofpacket     (ilc_component_avalon_slave_agent_rsp_fifo_out_endofpacket),   //                .endofpacket
		.rf_sink_data            (ilc_component_avalon_slave_agent_rsp_fifo_out_data),          //                .data
		.rf_source_ready         (ilc_component_avalon_slave_agent_rf_source_ready),            //       rf_source.ready
		.rf_source_valid         (ilc_component_avalon_slave_agent_rf_source_valid),            //                .valid
		.rf_source_startofpacket (ilc_component_avalon_slave_agent_rf_source_startofpacket),    //                .startofpacket
		.rf_source_endofpacket   (ilc_component_avalon_slave_agent_rf_source_endofpacket),      //                .endofpacket
		.rf_source_data          (ilc_component_avalon_slave_agent_rf_source_data),             //                .data
		.rdata_fifo_sink_ready   (avalon_st_adapter_001_out_0_ready),                           // rdata_fifo_sink.ready
		.rdata_fifo_sink_valid   (avalon_st_adapter_001_out_0_valid),                           //                .valid
		.rdata_fifo_sink_data    (avalon_st_adapter_001_out_0_data),                            //                .data
		.rdata_fifo_sink_error   (avalon_st_adapter_001_out_0_error),                           //                .error
		.rdata_fifo_src_ready    (ilc_component_avalon_slave_agent_rdata_fifo_src_ready),       //  rdata_fifo_src.ready
		.rdata_fifo_src_valid    (ilc_component_avalon_slave_agent_rdata_fifo_src_valid),       //                .valid
		.rdata_fifo_src_data     (ilc_component_avalon_slave_agent_rdata_fifo_src_data),        //                .data
		.m0_response             (2'b00),                                                       //     (terminated)
		.m0_writeresponsevalid   (1'b0)                                                         //     (terminated)
	);
	...
	altera_avalon_sc_fifo #(
		...
		.USE_ALMOST_FULL_IF  (0),
		.USE_ALMOST_EMPTY_IF (0)
	) ilc_component_avalon_slave_agent_rsp_fifo (
		.clk               (in_clk_50m_clk_clk),                                          //       clk.clk
		.reset             (avl_mm_bridge_reset_reset_bridge_in_reset_reset),             // clk_reset.reset
		.in_data           (ilc_component_avalon_slave_agent_rf_source_data),             //        in.data
		.in_valid          (ilc_component_avalon_slave_agent_rf_source_valid),            //          .valid
		.in_ready          (ilc_component_avalon_slave_agent_rf_source_ready),            //          .ready
		.in_startofpacket  (ilc_component_avalon_slave_agent_rf_source_startofpacket),    //          .startofpacket
		.in_endofpacket    (ilc_component_avalon_slave_agent_rf_source_endofpacket),      //          .endofpacket
		.out_data          (ilc_component_avalon_slave_agent_rsp_fifo_out_data),          //       out.data
		.out_valid         (ilc_component_avalon_slave_agent_rsp_fifo_out_valid),         //          .valid
		.out_ready         (ilc_component_avalon_slave_agent_rsp_fifo_out_ready),         //          .ready
		.out_startofpacket (ilc_component_avalon_slave_agent_rsp_fifo_out_startofpacket), //          .startofpacket
		.out_endofpacket   (ilc_component_avalon_slave_agent_rsp_fifo_out_endofpacket),   //          .endofpacket
		.csr_address       (2'b00),                                                       // (terminated)
		.csr_read          (1'b0),                                                        // (terminated)
		.csr_write         (1'b0),                                                        // (terminated)
		.csr_readdata      (),                                                            // (terminated)
	...
	soc_system_mm_interconnect_1_router router (
		.sink_ready         (avl_mm_bridge_m0_agent_cp_ready),                 //      sink.ready
		.sink_valid         (avl_mm_bridge_m0_agent_cp_valid),                 //          .valid
		.sink_data          (avl_mm_bridge_m0_agent_cp_data),                  //          .data
		.sink_startofpacket (avl_mm_bridge_m0_agent_cp_startofpacket),         //          .startofpacket
		.sink_endofpacket   (avl_mm_bridge_m0_agent_cp_endofpacket),           //          .endofpacket
		.clk                (in_clk_50m_clk_clk),                              //       clk.clk
		.reset              (avl_mm_bridge_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	soc_system_mm_interconnect_1_router router_001 (
		.sink_ready         (jtag_master_fpga_master_agent_cp_ready),          //      sink.ready
		.sink_valid         (jtag_master_fpga_master_agent_cp_valid),          //          .valid
		.sink_data          (jtag_master_fpga_master_agent_cp_data),           //          .data
		.sink_startofpacket (jtag_master_fpga_master_agent_cp_startofpacket),  //          .startofpacket
		.sink_endofpacket   (jtag_master_fpga_master_agent_cp_endofpacket),    //          .endofpacket
		.clk                (in_clk_50m_clk_clk),                              //       clk.clk
		.reset              (avl_mm_bridge_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	soc_system_mm_interconnect_1_router_002 router_003 (
		.sink_ready         (ilc_component_avalon_slave_agent_rp_ready),         //      sink.ready
		.sink_valid         (ilc_component_avalon_slave_agent_rp_valid),         //          .valid
		.sink_data          (ilc_component_avalon_slave_agent_rp_data),          //          .data
		.sink_startofpacket (ilc_component_avalon_slave_agent_rp_startofpacket), //          .startofpacket
		.sink_endofpacket   (ilc_component_avalon_slave_agent_rp_endofpacket),   //          .endofpacket
		.clk                (in_clk_50m_clk_clk),                                //       clk.clk
		.reset              (avl_mm_bridge_reset_reset_bridge_in_reset_reset),   // clk_reset.reset
	...
	altera_merlin_traffic_limiter #(
		...
		.cmd_src_ready          (avl_mm_bridge_m0_limiter_cmd_src_ready),          //   cmd_src.ready
		.cmd_src_data           (avl_mm_bridge_m0_limiter_cmd_src_data),           //          .data
		.cmd_src_channel        (avl_mm_bridge_m0_limiter_cmd_src_channel),        //          .channel
		.cmd_src_startofpacket  (avl_mm_bridge_m0_limiter_cmd_src_startofpacket),  //          .startofpacket
		.cmd_src_endofpacket    (avl_mm_bridge_m0_limiter_cmd_src_endofpacket),    //          .endofpacket
		...
		.rsp_src_ready          (avl_mm_bridge_m0_limiter_rsp_src_ready),          //   rsp_src.ready
		.rsp_src_valid          (avl_mm_bridge_m0_limiter_rsp_src_valid),          //          .valid
		.rsp_src_data           (avl_mm_bridge_m0_limiter_rsp_src_data),           //          .data
		.rsp_src_channel        (avl_mm_bridge_m0_limiter_rsp_src_channel),        //          .channel
		.rsp_src_startofpacket  (avl_mm_bridge_m0_limiter_rsp_src_startofpacket),  //          .startofpacket
		.rsp_src_endofpacket    (avl_mm_bridge_m0_limiter_rsp_src_endofpacket),    //          .endofpacket
		.cmd_src_valid          (avl_mm_bridge_m0_limiter_cmd_valid_data)          // cmd_valid.data
	);
	...
	altera_merlin_traffic_limiter #(
		...
		.SUPPORTS_NONPOSTED_WRITES (0),
		.REORDER                   (0)
	) jtag_master_fpga_master_limiter (
		.clk                    (in_clk_50m_clk_clk),                                    //       clk.clk
		.reset                  (avl_mm_bridge_reset_reset_bridge_in_reset_reset),       // clk_reset.reset
		...
		.cmd_src_ready          (jtag_master_fpga_master_limiter_cmd_src_ready),         //   cmd_src.ready
		.cmd_src_data           (jtag_master_fpga_master_limiter_cmd_src_data),          //          .data
		.cmd_src_channel        (jtag_master_fpga_master_limiter_cmd_src_channel),       //          .channel
		.cmd_src_startofpacket  (jtag_master_fpga_master_limiter_cmd_src_startofpacket), //          .startofpacket
		.cmd_src_endofpacket    (jtag_master_fpga_master_limiter_cmd_src_endofpacket),   //          .endofpacket
		...
		.rsp_src_ready          (jtag_master_fpga_master_limiter_rsp_src_ready),         //   rsp_src.ready
		.rsp_src_valid          (jtag_master_fpga_master_limiter_rsp_src_valid),         //          .valid
		.rsp_src_data           (jtag_master_fpga_master_limiter_rsp_src_data),          //          .data
		.rsp_src_channel        (jtag_master_fpga_master_limiter_rsp_src_channel),       //          .channel
		.rsp_src_startofpacket  (jtag_master_fpga_master_limiter_rsp_src_startofpacket), //          .startofpacket
		.rsp_src_endofpacket    (jtag_master_fpga_master_limiter_rsp_src_endofpacket),   //          .endofpacket
		.cmd_src_valid          (jtag_master_fpga_master_limiter_cmd_valid_data)         // cmd_valid.data
	);

	soc_system_mm_interconnect_1_cmd_demux cmd_demux (
		.clk                (in_clk_50m_clk_clk),                              //        clk.clk
		.reset              (avl_mm_bridge_reset_reset_bridge_in_reset_reset), //  clk_reset.reset
		.sink_ready         (avl_mm_bridge_m0_limiter_cmd_src_ready),          //       sink.ready
		.sink_channel       (avl_mm_bridge_m0_limiter_cmd_src_channel),        //           .channel
		.sink_data          (avl_mm_bridge_m0_limiter_cmd_src_data),           //           .data
		.sink_startofpacket (avl_mm_bridge_m0_limiter_cmd_src_startofpacket),  //           .startofpacket
		.sink_endofpacket   (avl_mm_bridge_m0_limiter_cmd_src_endofpacket),    //           .endofpacket
		.sink_valid         (avl_mm_bridge_m0_limiter_cmd_valid_data),         // sink_valid.data
	...
	soc_system_mm_interconnect_1_cmd_demux cmd_demux_001 (
		.clk                (in_clk_50m_clk_clk),                                    //        clk.clk
		.reset              (avl_mm_bridge_reset_reset_bridge_in_reset_reset),       //  clk_reset.reset
		.sink_ready         (jtag_master_fpga_master_limiter_cmd_src_ready),         //       sink.ready
		.sink_channel       (jtag_master_fpga_master_limiter_cmd_src_channel),       //           .channel
		.sink_data          (jtag_master_fpga_master_limiter_cmd_src_data),          //           .data
		.sink_startofpacket (jtag_master_fpga_master_limiter_cmd_src_startofpacket), //           .startofpacket
		.sink_endofpacket   (jtag_master_fpga_master_limiter_cmd_src_endofpacket),   //           .endofpacket
		.sink_valid         (jtag_master_fpga_master_limiter_cmd_valid_data),        // sink_valid.data
	...
	soc_system_mm_interconnect_0_avalon_st_adapter #(
		...
		.in_clk_0_clk   (in_clk_50m_clk_clk),                                     // in_clk_0.clk
		.in_rst_0_reset (avl_mm_bridge_reset_reset_bridge_in_reset_reset),        // in_rst_0.reset
	...
	soc_system_mm_interconnect_0_avalon_st_adapter #(
		...
		.in_clk_0_clk   (in_clk_50m_clk_clk),                                    // in_clk_0.clk
		.in_rst_0_reset (avl_mm_bridge_reset_reset_bridge_in_reset_reset),       // in_rst_0.reset
		.in_0_data      (ilc_component_avalon_slave_agent_rdata_fifo_src_data),  //     in_0.data
		.in_0_valid     (ilc_component_avalon_slave_agent_rdata_fifo_src_valid), //         .valid
		.in_0_ready     (ilc_component_avalon_slave_agent_rdata_fifo_src_ready), //         .ready
