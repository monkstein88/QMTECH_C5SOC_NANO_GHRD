	soc_system u0 (
		.button_pio_ext_export              (<connected-to-button_pio_ext_export>),              //          button_pio_ext.export
		.dipsw_pio_ext_export               (<connected-to-dipsw_pio_ext_export>),               //           dipsw_pio_ext.export
		...
		.hps_memory_mem_a                   (<connected-to-hps_memory_mem_a>),                   //              hps_memory.mem_a
		.hps_memory_mem_ba                  (<connected-to-hps_memory_mem_ba>),                  //                        .mem_ba
		.hps_memory_mem_ck                  (<connected-to-hps_memory_mem_ck>),                  //                        .mem_ck
		.hps_memory_mem_ck_n                (<connected-to-hps_memory_mem_ck_n>),                //                        .mem_ck_n
		.hps_memory_mem_cke                 (<connected-to-hps_memory_mem_cke>),                 //                        .mem_cke
		.hps_memory_mem_cs_n                (<connected-to-hps_memory_mem_cs_n>),                //                        .mem_cs_n
		.hps_memory_mem_ras_n               (<connected-to-hps_memory_mem_ras_n>),               //                        .mem_ras_n
		.hps_memory_mem_cas_n               (<connected-to-hps_memory_mem_cas_n>),               //                        .mem_cas_n
		.hps_memory_mem_we_n                (<connected-to-hps_memory_mem_we_n>),                //                        .mem_we_n
		.hps_memory_mem_reset_n             (<connected-to-hps_memory_mem_reset_n>),             //                        .mem_reset_n
		.hps_memory_mem_dq                  (<connected-to-hps_memory_mem_dq>),                  //                        .mem_dq
		.hps_memory_mem_dqs                 (<connected-to-hps_memory_mem_dqs>),                 //                        .mem_dqs
		.hps_memory_mem_dqs_n               (<connected-to-hps_memory_mem_dqs_n>),               //                        .mem_dqs_n
		.hps_memory_mem_odt                 (<connected-to-hps_memory_mem_odt>),                 //                        .mem_odt
		.hps_memory_mem_dm                  (<connected-to-hps_memory_mem_dm>),                  //                        .mem_dm
		.hps_memory_oct_rzqin               (<connected-to-hps_memory_oct_rzqin>),               //                        .oct_rzqin
